...
values
    ...
    ('Chamomile', 'Elevate your garden with our premium Chamomile planting material. Cultivate a serene oasis with these fragrant blooms. Shop now for a tranquil touch to your green space.', 1.7, 1, 'https://files.nccih.nih.gov/chamomile-steven-foster-square.jpg', NULL, '2025-02-15 11:55:00', NULL),
...
values
    ('123 Main St, City', '+49123456789', 'SELF_PICKUP', 'PENDING_PAYMENT', '2025-03-13 14:15:00', null, 1),
    ('456 Elm St, City', '+49123456790', 'COURIER_DELIVERY', 'CREATED', '2025-03-14 10:30:00', NULL, 2),
    ('789 Oak St, City', '+49123456791', 'SELF_PICKUP', 'PAID', '2025-03-15 08:45:00', NULL, 3),
    ('321 Pine St, City', '+49123456792', 'COURIER_DELIVERY', 'IN_TRANSIT', '2025-03-16 12:10:00', NULL, 4),
    ('654 Birch St, City', '+49123456793', 'SELF_PICKUP', 'DELIVERED', '2025-03-17 16:25:00', NULL, 5),
    ('987 Cedar St, City', '+49123456794', 'COURIER_DELIVERY', 'CANCELED', '2025-03-18 09:50:00', NULL, 6),
    ('159 Maple St, City', '+49123456795', 'SELF_PICKUP', 'PENDING_PAYMENT', '2025-03-19 14:05:00', NULL, 7),
    ('753 Spruce St, City', '+49123456796', 'COURIER_DELIVERY', 'CREATED', '2025-03-20 18:40:00', NULL, 8),
    ('852 Walnut St, City', '+49123456797', 'SELF_PICKUP', 'PAID', '2025-03-21 11:15:00', NULL, 9),
    ('951 Ash St, City', '+49123456798', 'COURIER_DELIVERY', 'IN_TRANSIT', '2025-03-22 15:30:00', NULL, 10),
    ('753 Fir St, City', '+49123456799', 'SELF_PICKUP', 'DELIVERED', '2025-03-23 10:00:00', NULL, 11),
    ('357 Cherry St, City', '+49123456800', 'COURIER_DELIVERY', 'CANCELED', '2025-03-24 12:55:00', NULL, 12),
    ('123 Main St, City', '+49123456789', 'SELF_PICKUP', 'PENDING_PAYMENT', '2025-03-25 14:45:00', NULL, 1),
    ('369 Redwood St, City', '+49123456802', 'COURIER_DELIVERY', 'PAID', '2025-03-26 16:35:00', NULL, 14),
    ('147 Beech St, City', '+49123456803', 'SELF_PICKUP', 'IN_TRANSIT', '2025-03-27 09:20:00', NULL, 15);
